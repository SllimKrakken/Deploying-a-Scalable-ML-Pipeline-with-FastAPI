...
assert_type(
    divmod(i8, i4),
    tuple[np.signedinteger[_64Bit], np.signedinteger[_64Bit]]
    | tuple[np.signedinteger[_32Bit], np.signedinteger[_32Bit]],
)
assert_type(
    divmod(i8, f4),
    tuple[np.floating[_64Bit], np.floating[_64Bit]]
    | tuple[np.floating[_32Bit], np.floating[_32Bit]],
)
...
assert_type(
    divmod(i8, AR_b),
    tuple[npt.NDArray[np.signedinteger[Any]], npt.NDArray[np.signedinteger[Any]]],
)
...
assert_type(divmod(f8, f8), tuple[np.float64, np.float64])
assert_type(
    divmod(f4, f8), tuple[np.float64, np.float64] | tuple[np.float32, np.float32]
)
assert_type(divmod(f4, f4), tuple[np.float32, np.float32])
assert_type(
    divmod(AR_b, f8),
